...
namespace ImperialStudio.Core.Scheduling
{
    ...
    {        
        ...
        public static ITask ScheduleNextFrame(this ITaskScheduler taskScheduler, object @owner, Action action, string taskName) 
        ...
        /// <param name="owner">The owner of the task.</param>
        /// <param name="taskName">The tasks human friendly name.</param>
        public static ITask ScheduleEveryFrame(this ITaskScheduler taskScheduler, object @owner, Action action, string taskName) 
        ...
        /// <param name="owner">The owner of the task.</param>
        /// <param name="taskName">The tasks human friendly name.</param>
        public static ITask ScheduleNextPhysicUpdate(this ITaskScheduler taskScheduler, object @owner, Action action, string taskName) 
        ...
        /// <param name="owner">The owner of the task.</param>
        /// <param name="taskName">The tasks human friendly name.</param>
        public static ITask ScheduleNextAsyncFrame(this ITaskScheduler taskScheduler, object @owner, Action action, string taskName) 
        ...
        /// <param name="taskName">The tasks human friendly name.</param>
        public static ITask ScheduleDelayed(this ITaskScheduler taskScheduler, object @object, Action action, string taskName, TimeSpan delay, bool runAsync = false)
