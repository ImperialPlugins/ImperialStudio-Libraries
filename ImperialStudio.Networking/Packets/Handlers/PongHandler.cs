...
namespace ImperialStudio.Networking.Packets.Handlers
{
    ...
    public class PongHandler : BasePacketHandler<PongPacket>
    {
        ...
        public PongHandler(IEventBus eventBus, IObjectSerializer objectSerializer, IGamePlatformAccessor gamePlatformAccessor, IConnectionHandler connectionHandler, ILogger logger) : base(objectSerializer, gamePlatformAccessor, connectionHandler, logger)
        {
            m_EventBus = eventBus;
        }
