...
namespace ImperialStudio.Networking.Codegen
{
...
#pragma warning disable 168
    public static partial class ZeroFormatterInitializer
    {
        ...
        public static void Register()
        {
            ...
            registered = true;
            // Enums
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::Facepunch.Steamworks.ServerAuth.Status>.Register(new ServerAuth_StatusFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Comparers.ZeroFormatterEqualityComparer<global::Facepunch.Steamworks.ServerAuth.Status>.Register(new ServerAuth_StatusEqualityComparer());
            
            // Objects
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.AuthenticatePacket>.Register(new AuthenticatePacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.InputUpdatePacket>.Register(new InputUpdatePacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.MapChangePacket>.Register(new MapChangePacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.PingPacket>.Register(new PingPacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.PongPacket>.Register(new PongPacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.TerminatePacket>.Register(new TerminatePacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>.Register(new WorldSpawnFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.WorldUpdatePacket>.Register(new WorldUpdatePacketFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Core.Serialization.SerializableVector3>.Register(new SerializableVector3Formatter<ZeroFormatter.Formatters.DefaultResolver>());
            // Structs
            // Unions
            // Generics
            ZeroFormatter.Formatters.Formatter.RegisterDictionary<ZeroFormatter.Formatters.DefaultResolver, int, byte[]>();
            ZeroFormatter.Formatters.Formatter.RegisterEnumerable<ZeroFormatter.Formatters.DefaultResolver, global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>();
...
#pragma warning disable 414
#pragma warning disable 168
    public class AuthenticatePacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.AuthenticatePacket>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.AuthenticatePacket value)
        {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.AuthenticatePacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
    ...
    public class AuthenticatePacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.AuthenticatePacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
    ...
    public class InputUpdatePacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.InputUpdatePacket>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.InputUpdatePacket value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.InputUpdatePacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class InputUpdatePacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.InputUpdatePacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
    ...
    public class MapChangePacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.MapChangePacket>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.MapChangePacket value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.MapChangePacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class MapChangePacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.MapChangePacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
    ...
    public class PingPacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.PingPacket>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.PingPacket value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.PingPacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class PingPacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.PingPacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
    ...
    public class PongPacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.PongPacket>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.PongPacket value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.PongPacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class PongPacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.PongPacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
        static readonly int[] __elementSizes = new int[]{ 8 };
    ...
    public class TerminatePacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.TerminatePacket>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.TerminatePacket value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.TerminatePacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class TerminatePacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.TerminatePacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
    ...
    public class WorldSpawnFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class WorldSpawnObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
    ...
    public class WorldUpdatePacketFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ImperialStudio.Networking.Packets.Handlers.WorldUpdatePacket>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ImperialStudio.Networking.Packets.Handlers.WorldUpdatePacket value)
        {
            var segment = value as IZeroFormatterSegment;
            if (segment != null)
            {
            ...
            else
            {
                ...
                offset += (8 + 4 * (2 + 1));
                offset += ObjectSegmentHelper.SerializeFromFormatter<TTypeResolver, global::System.Collections.Generic.IEnumerable<global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>>(ref bytes, startOffset, offset, 0, value.Spawns);
        ...
        public override global::ImperialStudio.Networking.Packets.Handlers.WorldUpdatePacket Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = BinaryUtil.ReadInt32(ref bytes, offset);
            if (byteSize == -1)
            {
    ...
    public class WorldUpdatePacketObjectSegment<TTypeResolver> : global::ImperialStudio.Networking.Packets.Handlers.WorldUpdatePacket, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        CacheSegment<TTypeResolver, global::System.Collections.Generic.IEnumerable<global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>> _Spawns;
        ...
        // 0
        public override global::System.Collections.Generic.IEnumerable<global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn> Spawns
        {
            get
            {
        ...
        public WorldUpdatePacketObjectSegment(global::ZeroFormatter.DirtyTracker dirtyTracker, ArraySegment<byte> originalBytes)
        {
            ...
            _Spawns = new CacheSegment<TTypeResolver, global::System.Collections.Generic.IEnumerable<global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>>(__tracker, ObjectSegmentHelper.GetSegment(originalBytes, 0, __binaryLastIndex, __tracker));
        ...
        public int Serialize(ref byte[] targetBytes, int offset)
        {
            if (__extraFixedBytes != null || __tracker.IsDirty)
            {
                ...
                offset += ObjectSegmentHelper.SerializeCacheSegment<TTypeResolver, global::System.Collections.Generic.IEnumerable<global::ImperialStudio.Networking.Packets.Handlers.WorldSpawn>>(ref targetBytes, startOffset, offset, 0, ref _Spawns);
