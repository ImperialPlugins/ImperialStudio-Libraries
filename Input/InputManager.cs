...
namespace ImperialStudio.Core.Input
{
    public class InputManager
    {
        ...
        public bool GetKeyDown(string keyName)
        {
            ...
            return UnityEngine.Input.GetKeyDown(_keyMappings[keyName]);
        }
        ...
        public bool GetKeyUp(string keyName)
        {
            ...
            return UnityEngine.Input.GetKeyUp(_keyMappings[keyName]);
        }
        ...
        public bool GetKey(string keyName)
        {
            ...
            return UnityEngine.Input.GetKey(_keyMappings[keyName]);
        }
